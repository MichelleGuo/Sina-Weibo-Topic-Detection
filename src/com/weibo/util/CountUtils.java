...
public class CountUtils {
	...
	public static void main(String[] args) throws IOException {
		...
		File file = new File("D:/Java/workSpace/MyWeiboMining/src");
		CountUtils jsu = new CountUtils();
		System.out.println(jsu.staticRowsByDirectory(file));

		OutputStream os = new FileOutputStream(new File("d:/totalCode.java"));
